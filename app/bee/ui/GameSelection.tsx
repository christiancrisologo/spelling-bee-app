...
import OptionGroup, { OptionProps } from "./OptionGroup";

type GameSelectionProps = {
    onStart: (gameSelection: SelectedGameOptionType) => void
}
        ...
        <div className="flex justify-center flex-col">
            <div className="flex justify-center  self-center flex-col mb-4">
                ...
                <div className="flex-row mt-2">
                    <label htmlFor="total-seconds-number" className="self-center me-4 text-blue-900 font-medium disabled:text-gray-200" >Total Seconds</label>
                    <input
                        ...
                        value={gameSelection.enableTimer=== "On" ? gameSelection.totalSeconds : 0}
                ...
                <div className="flex mt-4 flex-row">
                    <label htmlFor="total-words-number" className="self-center me-8 text-blue-900 font-medium">Total Words</label>
                    <input
